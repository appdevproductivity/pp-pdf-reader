<section class="pp-page-header">
  ...
  <div>
    <p class="pp-kicker">Read and Annotate Feature Highlights</p>
...
<section class="pp-feature-list">
  ...
  <a class="pp-feature-list-card pp-feature-link" href="../pencil-gestures/" aria-label="Open Pencil annotation gestures details">
  ...
  <a class="pp-feature-list-card pp-feature-link" href="../touch-gestures/" aria-label="Open additional finger touch gestures details">
    <img src="../app-icon/Icon-58.png" alt="">
    <div>

      <h2>Additional finger touch gestures <span class="pp-feature-link-label">Explore feature</span></h2>
      <p>Multi-touch gestures—like a one-finger swipe, two-finger swipe, or double-tap—are readily available to trigger specific actions.</p>
